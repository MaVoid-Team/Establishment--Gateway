...
const Sidebar = React.forwardRef((
  ...
  return (
    (<div
      ...
      <div
        className={cn(
          "duration-200 relative h-svh w-[--sidebar-width] backdrop-blur-2xl bg-transparent/5 transition-[width] ease-linear",
...
const SidebarTrigger = React.forwardRef(({ className, onClick, ...props }, ref) => {
  ...
  return (
    (<Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-7 w-7 fixed bg-blue-950/5", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
const SidebarMenuItem = React.forwardRef(({ className, ...props }, ref) => (
  <li
    ...
    className={cn("group/menu-item relative duration-300 rounded-sm", className)}
    {...props} />
))
...
const SidebarMenuAction = React.forwardRef(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    (<Comp
      ...
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-lg p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0 ",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 after:md:hidden",
...
const SidebarMenuSkeleton = React.forwardRef(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    (<div
      ...
      {...props}>
      {showIcon && (
        <Skeleton className="rounded-lg size-4" data-sidebar="menu-skeleton-icon" />
      )}
      <Skeleton
