...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "  rounded-sm text-black font-bold dark:text-white shadow shadow-sm hover:shadow-sm hover:shadow-primary/50 backdrop-blur-sm hover:backdrop-blur-sm",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90 rounded-sm",
        outline:
          "border-input hover:bg-accent hover:text-accent-foreground shadow-sm hover:bg-accent hover:text-accent-foreground rounded-sm",
        secondary:
